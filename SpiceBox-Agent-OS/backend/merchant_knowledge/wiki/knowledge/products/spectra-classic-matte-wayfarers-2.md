---
type: product
slug: spectra-classic-matte-wayfarers-2
name: Spectra Classic Matte Wayfarers Series 2
...
# Spectra Classic Matte Wayfarers Series 2

## Overview

Crafted with lightweight Italian acetate and durable stainless steel barrel hinges. Protects eyes with crisp contrast clarity.

> ⚠️ **Data Conflict: category**  
> Previous: `Eyewear & Sunglasses` (Source: `db_catalog_1`)  
> New: `Wearables & Tech` (Source: `db_catalog_1`)  
> Status: _Requires resolution_  
> Preferred: _manufacturer_spec | latest_source | merchant_override_
...
> Previous: `30 EUR` (Source: `db_catalog_1`)  
> New: `33 USD` (Source: `db_catalog_1`)  
> Status: _Requires resolution_  
> Preferred: _manufacturer_spec | latest_source | merchant_override_
...
- [Spectra Classic Matte Wayfarers Series 7](./spectra-classic-matte-wayfarers-7.md) (Complementary)
